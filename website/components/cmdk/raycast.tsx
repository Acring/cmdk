      ...
      <Command value={value} onValueChange={(v) => setValue(v)}>
        ...
        <Command.List ref={listRef}>
          ...
          <Command.Group heading="Suggestions">
            <Item value="Linear" keywords={['Linear', 'issue', 'sprint']}>
              <Logo>
                <LinearIcon
                  style={{
                    width: 12,
            ...
            <Item value="Figma" keywords={['Figma', 'design', 'ui', 'ux']}>
              <Logo>
                <FigmaIcon />
              </Logo>
              Figma
            </Item>
            <Item value="Slack" keywords={['Slack', 'chat', 'team', 'communication']}>
              <Logo>
                <SlackIcon />
              </Logo>
              Slack
            </Item>
            <Item value="YouTube" keywords={['Youtube', 'video', 'watch', 'stream']}>
              <Logo>
                <YouTubeIcon />
              </Logo>
              YouTube
            </Item>
            <Item value="Raycast" keywords={['Raycast', 'productivity', 'tools', 'apps']}>
              <Logo>
                <RaycastIcon />
              </Logo>
              Raycast
          ...
          <Command.Group heading="Commands">
            <Item isCommand value="Clipboard History" keywords={['Clipboard History', 'copy', 'paste', 'clipboard']}>
              <Logo>
                <ClipboardIcon />
              </Logo>
              Clipboard History
            </Item>
            <Item isCommand value="Import Extension" keywords={['Import Extension', 'import', 'extension']}>
              <HammerIcon />
              Import Extension
            </Item>
            <Item isCommand value="Manage Extensions" keywords={['Manage Extensions', 'manage', 'extension']}>
              <HammerIcon />
              Manage Extensions
            </Item>
          </Command.Group>
